<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Brochem.index" %>
                            ...
                            <div class="single-about-detail clearfix">
								...
								<h3>Children’s specialist</h3>--%>
                                    <p style="padding-top: 30px; padding-bottom: 60px">
                                        ...
                                        <%--BROCHEM AMBALAJ GIDA KIMYA ITHALAT
                                   IHRACAT  SAN. TIC. LTD.STI. 1 Nisan 2016
                                   tarihinde  konularında uzman bir grup
                                   Kimya Mühendisi tarafından kurulmuş
                                   bir şirkettir.--%>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="single-about-detail">
								...
								<h3>Children’s specialist</h3>--%>
                                    <p style="padding-top: 30px; padding-bottom: 40px">
                                        ...
                                        <%--Şirketin kuruluş  amacı Flexsible  ambalaj
                                   sektöründeki 22 yılı aşkın tecrübesi, bilgi birikimi ile
                                   gerek Türkiye’ de gerekse yurt dışında
                                   müşterilerine çözüm ortağı olarak  hizmet
                                   vermektir.--%>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="single-about-detail">
								...
								<h3>Children’s specialist</h3>--%>
                                    <p style="padding-top: 30px; padding-bottom: 25px">
                                        ...
                                        <%-- Ambalaj sektöründeki özellikle fleksible ambalaj
                                                                                sektöründeki bilgi birikimimizi yurtiçinde ve yurtdışındaki
                                                                                ambalaj firmaları ile çözüm ortaklığı
                                                                                modeli ile çalışarak gelişimlerine yardımcı olmak,
                                                                                ambalaj sektörünün gelişimine katkıda bulunmak.--%>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-about-detail clearfix">
                                ...
                                <div class="about-details">
                                    ...
                                    <h3>
                                        <asp:Label runat="server" ID="lblFleksiblePackage"></asp:Label></h3>
                                    <p style="padding-bottom: 68px">
                                        <asp:Label runat="server" ID="lblFleksiblePackageDetail"></asp:Label>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-about-detail">
                                ...
                                <div class="about-details">
                                    ...
                                    <h3>
                                        <asp:Label runat="server" ID="lblFoodSector"></asp:Label></h3>
                                    <p>
                                        <asp:Label runat="server" ID="lblFoodSectorDetail"></asp:Label><%--Her türlü gıdanın ambalajlanması için bilgi paylaşımı, ambalaj malzemesi temini, gıda ihracatı ve ithalatı ( Yurtdışı firmamız ve çözüm ortaklarımız  vasıtasıyla ) özellikle Balkan ülkeleriyle ticaret  imkanları sağlamak--%></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="single-about-detail">
                                ...
                                <div class="about-details">
                                    ...
                                    <h3>
                                        <asp:Label runat="server" ID="lblChemistrySector"></asp:Label></h3>
                                    <p style="padding-bottom: 68px">
                                        <asp:Label runat="server" ID="lblChemistrySectorDetail"></asp:Label><%--Kimya ürünlerinin  ihracatı ve ithalatı, fason üretim vb alanlarda çözüm ortağınız olarak hizmet vermekteyiz.--%></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="contact-caption clearfix">
                            ...
                            <div class="col-md-5 contact-info text-left">
                                ...
                                <div class="info-detail">
                                    ...
                                    <ul>
                                        <li><i class="fa fa-fax"></i><span>Fax:</span></li>
                                    </ul>
                                    <ul>
